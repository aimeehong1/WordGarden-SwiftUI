...
//  WordGarden-SwiftUI
//
//  Created by Aimee Hong on 9/22/24.
//
...
struct ContentView: View {
    ...
    func updateGamePlay() {
        ...
        if !revealedWord.contains("_") { // Word has been guessed when no _ in revealedWord
            gameStatusMessage = "You've Guessed It! It Took You \(lettersGuessed.count) Guess\(lettersGuessed.count == 1 ? "" : "es") to Guess the Word."
            wordsGuessed += 1
            currentWordIndex += 1
